...
def build_parser():
    default_input = Path("results/black_scholes/time_std/predictions.csv")
    default_output = Path(__file__).with_suffix(".pdf")

    parser = argparse.ArgumentParser(
        description="Plot a Black-Scholes pointwise absolute-error heatmap."
    )
