"""Plot Black-Scholes Greek references against GPR approximations."""
...
def plot_greeks(
    ...
    *,
    ...
    """Create the 3-by-3 Black-Scholes Greek comparison figure."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Plot Black-Scholes reference Greeks against GPR Greeks."
    )
    parser.add_argument(
        "--input",
        type=Path,
        default=Path("results/black_scholes/greeks/predictions.csv"),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("graphs/numex/Figure7_4.pdf"),
    )
